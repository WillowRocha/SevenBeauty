...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Jun-2018 às 03:30
...
CREATE TABLE `clientes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ativo` tinyint(1) NOT NULL,
  `local_trabalho` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Estrutura da tabela `funcionarios_servicos`
--
...
CREATE TABLE `usuarios` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `nome_usuario` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Indexes for table `agendamentos_servicos`
--
...
--
-- Indexes for table `funcionarios_servicos`
--
ALTER TABLE `funcionarios_servicos`
...
--
-- Limitadores para a tabela `agendamentos_servicos`
--
ALTER TABLE `agendamentos_servicos`
...
--
ALTER TABLE `fornecedores`
  ADD CONSTRAINT `id_categoria_produto` FOREIGN KEY (`id_categoria_produto`) REFERENCES `categorias_produto` (`id`);
...
--
-- Limitadores para a tabela `funcionarios_servicos`
--
ALTER TABLE `funcionarios_servicos`
