            ...
            <div class="card-body">
                <div id="table" class="table-editable">
                    ...
                    <table class="table table-bordered table-responsive-md table-striped text-center">
                        ...
                        <?php 
                            $dao = new GerenteDao();
                            $gerentes = $dao->buscaAtivos();
                            $dao = new ProfissionalDao();
                            $profissionais = $dao->buscaAtivos();
                            
                            $funcionarios = array_merge($gerentes, array());
                            $size = count($funcionarios);
                            if($size > 0):
                        ?>
                            <?php
                                $count = 0;
                            ...
                            ?>
                                <tr>
                                    <td class="pt-3-half">
                                        <?php echo $funcionario->getNome()." ".$funcionario->getSobrenome(); ?>
                                    </td>
                                    <td class="pt-3-half">
                                    ...
                                    <td class="pt-3-half">
                                        <?php echo $funcionario->getRG()."<p></p>".$funcionario->getCPF(); ?>
                                    </td>
                                    <td class="pt-3-half">
                                        <?php echo $funcionario->getCargo()->getNome(); ?>
                                    </td>
                                    <td class="pt-3-half">
